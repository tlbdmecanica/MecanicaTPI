...
<body>
    ...
    <div class="container">
        <div class="row">
            <form method="post" action="/registrarUsuario" enctype="text/plain">
                <div class="row" style="padding-top:67px; padding-bottom:107px">
                    ...
                    <div class="input-field offset-s3 col s6">
                        ...
                        <input id="name" type="text" class="validate" required="" autofocus="">
