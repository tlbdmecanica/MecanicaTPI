  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <a href="#modal1" class="btn-large waves-effect popout waves-light teal lighten-1 modal-trigger">Entre</a>

          <div id="modal1" class="modal modal-fixed-footer" style="color:black; height:55%; width:55%;">
              ...
              <form action="/logar" method="post">
                <div class="row">
                  ...
                  <div class="input-field offset-s3 col s6">
                    ...
                    <input id="senha" type="password" name="senha" class="validate" required="" autofocus="">
            ...
            <div class="modal-footer">
              <a href="#!" class="modal-close modal-action waves-effect waves-teal btn-flat">Fechar</a>
              <button type="submit" class="modal-action waves-effect waves-teal btn-flat ">Vamos</button>
            </div>
          </div>
          </form>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Nosso tempo para o conserto dos automóveis é extremamente curto, possuímos as melhores ferramentas para identificar
              o problema e resolvê-lo.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Nossos funcionários são totalmente qualificados e foram escolhidos a dedo para atender aos seus problemas mecânicos.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Nossos clientes sempre saem satisfeito depois de um conserto e a maioria dos clientes vem por recomendaç, somos
              a favorita entre as mecânicas.</p>
          </div>
        </div>
      </div>
    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12 center">
          ...
          <h4>Contate-nos</h4>
          <p class="center-align light">Caso você tenha alguma dúvida, sugestão ou opinião contate-nos através desse formulário, sua opinião é muito importante
            para nós!</p>
          <div class="row">
