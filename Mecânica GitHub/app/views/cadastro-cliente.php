...
<body>
    ...
    <div class="container">
        <div class="row">
            <form method="post" action="/salvar_clientetabela" >
                <div class="row">
                    ...
                    <div class="input-field offset-s3 col s6">
                        ...
                        <input name="clientenome" id="clientenome" type="text" class="validate">
                    ...
                    <div class="input-field offset-s3 col s6">
                        ...
                        <input name="estado" id="estado" type="text" class="validate">
